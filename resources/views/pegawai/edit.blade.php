    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <div class="card-header d-md-flex flex-row justify-content-between">
                <h5 class="card-title">Ubah Pegawai</h5>
                <div>
            ...
            <div class="card-body">
                <form action="{{ route('pegawai.update', $pegawai->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control"
                                value="{{ old('nip') ?? $pegawai->nip }}"name="nip" id="nip" required
                                placeholder="Silahkan masukan Nomor Pokok Pegawai">
                        </div>
                    </div>
                    @error('nip')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control"
                                value="{{ old('jabatan_id') ?? $pegawai->jabatan_id }}"name="jabatan_id" id="jabatan_id"
                                required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"
                                value="{{ old('nama') ?? $pegawai->nama }}"name="nama" id="nama" required
                                placeholder="Silahkan masukan nama pegawai">
                        </div>
                    </div>
                    @error('nama')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control"
                                value="{{ old('tanggal_lahir') ?? $pegawai->tanggal_lahir }}"name="tanggal_lahir"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea type="number" class="form-control" name="alamat" id="alamat" required
                                placeholder="Silahkan masukan alamat pegawai">{{ old('alamat') ?? $pegawai->alamat }}</textarea>
                        </div>
                    </div>
                    @error('thn_masuk')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="2000" max="{{ date('Y') }}" class="form-control"
                                value="{{ old('thn_masuk') ?? $pegawai->thn_masuk }}"name="thn_masuk" id="thn_masuk"
                                required placeholder="Silahkan masukan tahun masuk pegawai">
                        </div>
                    </div>
                    @error('thn_masuk')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="2000" max="{{ date('Y') }}" class="form-control"
                                value="{{ old('thn_keluar') ?? $pegawai->thn_keluar }}"name="thn_keluar" id="thn_keluar"
